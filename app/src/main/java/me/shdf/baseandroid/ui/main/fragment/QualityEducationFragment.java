...
public class QualityEducationFragment extends BaseFragment {
    ...
    public int getContentLayoutId() {
        return R.layout.fragment_quality_education;
    }
    ...
    public static QualityEducationFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        QualityEducationFragment pageFragment = new QualityEducationFragment();
