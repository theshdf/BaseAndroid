...
public class MiddleToHighFragment extends BaseFragment {
    ...
    public int getContentLayoutId() {
        return R.layout.fragment_middle_to_high;
    }
    ...
    public static MiddleToHighFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        MiddleToHighFragment pageFragment = new MiddleToHighFragment();
