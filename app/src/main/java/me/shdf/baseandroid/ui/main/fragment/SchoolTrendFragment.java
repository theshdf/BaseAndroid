...
public class SchoolTrendFragment extends BaseFragment {
    ...
    public int getContentLayoutId() {
        return R.layout.fragment_school_trend;
    }
    ...
    public static SchoolTrendFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        SchoolTrendFragment pageFragment = new SchoolTrendFragment();
